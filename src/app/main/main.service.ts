...
export class MainService {
    ...
    private getCabinetTree(): TreeNode[] {
        ...
        var cabinetTree: TreeNode[] = [
            ...
            { imgPath: 'img/interior.png', name: '內政部', description: '美國內務部（United States Department of the Interior，DOI）負責管理聯邦政府擁有的土地和保護自然資源，並負責有關印第安人、阿拉斯加原住民和夏威夷原住民領土事務，和美國島嶼地區。這與大多數國家的內政部負責警察或安全事務不同。通常美國內務部的部長都由來自美西的人士擔任。這是由於大部分的國有地在美國西部。' },
            { imgPath: 'img/agriculture.png', name: '農業部', description: '美國農業部（United States Department of Agriculture，縮寫： USDA）是美國聯邦政府的一個內閣部門。前身是1862年5月15日成立的聯邦政府農業司，1889年1月15日改為農業部。1994年根據《農業部重組法》進行了重組。' },
            { imgPath: 'img/commerce.png', name: '商務部', description: '美國商務部（英語：United States Department of Commerce），是美國聯邦行政部門之一，負責美國國際貿易、出口管制、貿易救濟措施等。' },
            { imgPath: 'img/labor.png', name: '勞工部', description: '美國勞工部（英語：United States Department of Labor），是美國聯邦政府行政部門之一，主管全國勞工事務，成立於1913年3月4日。現任部長為2013年7月上任的托馬斯·佩雷斯。曾任部長為美籍華人趙小蘭女士。' },
            { imgPath: 'img/health.png', name: '衛生及公共服務部', description: '美國衛生和公眾服務部（United States Department of Health and Human Services；HHS）是維護美國公民健康，提供公眾服務的聯邦政府行政部門。本部門於1979年10月17日由美國總統吉米·卡特簽署的教育部組織法案（PL 96-88）成立。該法案將原衛生、教育及福利部（United States Department of Health, Education, and Welfare）劃分為衛生及公共服務部和單獨的教育部。這兩個部門均於1980年5月4日開始運作。本部門由衛生和公眾服務部長領導。' },
            { imgPath: 'img/housing.png', name: '住房及城市發展部', description: '住房及城市發展部（英語：Department of Housing and Urban Development，HUD；另譯為住宅暨都市發展部），是美國內閣部門之一，成立於1965年9月9日。' },
            { imgPath: 'img/trsnsportation.png', name: '運輸部', description: '美國運輸部（DoT, United States Department of Transportation），是美國聯邦政府的交通部門，1966年10月15日美國國會通過設立運輸部法案，1967年4月1日正式辦公。負責管理航空、鐵路、聯邦公路、海事、公共運輸等方面。' },
            { imgPath: 'img/energy.png', name: '能源部', description: '美國能源部（United States Department of Energy）主要負責美國聯邦政府能源政策制定，能源行業管理，能源相關技術研發、武器研製等。' },
            { imgPath: 'img/education.png', name: '教育部', description: '美國教育部（United States Department of Education，縮寫：ED）為美國內閣層級的聯邦政府部門，由《教育部門組織條例》(Department of Education Organization Act， Public Law 96-88)成立，由吉米·卡特總統於1979年10月17日簽署生效，並於次年5月4日開始運行。《教育部門組織條例》將原先的「美國衛生、教育及福利部」重組為「美國教育部」以及「美國衛生及公共服務部」，教育部由美國教育部長管理。教育部是目前最小的內閣層級聯邦部門，只有約5000名雇員。教育部正式的英文縮寫是ED，而不是DOE（美國能源部英文縮寫）。不同於其他國家的教育部，美國教育部不干涉課程標準的設置（現今的「有教無類法案」，或稱「不讓任何孩子落後法案」，是個例外），地方及州政府掌管教育權並決定大部分課程。教育部主要的職權在於編列聯邦補助方案，以及執行聯邦關於民權及隱私的教育法案。' },
            { imgPath: 'img/veterans.png', name: '退伍軍人事務部', description: '美國退伍軍人事務部 （United States Department of Veterans Affairs，VA），成立於1989年，是為美國退伍軍人及家屬提供服務的內閣部門。美國退伍軍人事務部具體為服務對象提供傷殘賠償金，養老金，教育，住房貸款，人壽保險，職業康復，遺屬福利，醫療福利和安葬等權益及服務。退伍軍人事務部的前身為1930年成立的退伍軍人管理局。現任部長為羅伯特·麥克唐納。2009年總預算約為876億美元，共僱傭了大約34.5萬人。2012年，預算為1320億美元[1]，2014年為1527億美元。' },
            { imgPath: 'img/homeland.png', name: '國土安全部', description: '美國國土安全部（英語：United States Department of Homeland Security, DHS），是美國聯邦政府於2003年1月24日成立的聯邦行政部門，是目前美國最年輕的聯邦行政部門。國土安全部負責美國境內的邊境管制、情報統籌、緊急應變以及防止恐怖活動[1]。另外負責保護美國總統等重要政要的特勤局，亦屬於該部。' }
        ];
